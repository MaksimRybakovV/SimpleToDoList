...
namespace WebApi.Services.TodoTaskService
{
    public interface ITodoTaskService
    {
        ...
        public Task<PageServiceResponce<List<GetTodoTaskDto>>> GetTodosByPageAsync(int page, int pageSize);
        public Task<ServiceResponce<List<GetTodoTaskDto>>> GetAllUsersTodosAsync(int userId);
        public Task<PageServiceResponce<List<GetTodoTaskDto>>> GetUsersTodosByPageAsync(int userId, int page, int pageSize);
